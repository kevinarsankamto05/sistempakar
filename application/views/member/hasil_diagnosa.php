<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.html"><span>SP</span>PADI</a>
      ...
      <div class="row">
        <div class="col-lg">
          ...
          <div class="page three">
            ...
            <div class="row progress-circle mb-5">
              <?php foreach ($diagnosa as $diag) : ?>
                ...
                if ($diag['id_penyakit'] == 1) {
                  $diag['id_penyakit'] = 'Hawar Daun';
                } elseif ($diag['id_penyakit'] == 2) {
                  $diag['id_penyakit'] = 'Kardil';
                } elseif ($diag['id_penyakit'] == 3) {
                  $diag['id_penyakit'] = 'Tungro';
                } elseif ($diag['id_penyakit'] == 4) {
                  $diag['id_penyakit'] = 'Leaf Streak';
            ...
            <div class="row">
              <h4>Berdasarkan Gejala-Gejala yang telah dipilih,maka maka dapat dinyatakan terjangkit penyakit :</h4>
              <br>
              <?php foreach ($tertinggi as $tinggi) : ?>
                <?php
                if ($tinggi['id_penyakit'] == 1) {
                  $tinggi['id_penyakit'] = 'Hawar Daun';
                } elseif ($tinggi['id_penyakit'] == 2) {
                  $tinggi['id_penyakit'] = 'Kardil';
                } elseif ($tinggi['id_penyakit'] == 3) {
                  $tinggi['id_penyakit'] = 'Tungro';
                } elseif ($tinggi['id_penyakit'] == 4) {
                  $tinggi['id_penyakit'] = 'Leaf Streak';
                } 
